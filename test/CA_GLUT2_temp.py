...
LOCAL = './GLUT2_BG_annotated.ttl#'
MODEL_BASE = './GLUT2_BG_annotated.cellml#'
...
local_source_glucose={'glucose_out':{'type': 'local','term': 'CHEBI:4167', 'partOf': 'intercellular_matrix', 'hasProperty': [('b4da8a','OPB:00425'),('b4da99','OPB:00378')]}}
local_sink_glucose ={'glucose_in':{'type': 'local','term': 'CHEBI:4167', 'partOf': 'portionOfCytosol', 'hasProperty': [('b4da88','OPB:00425'),('b4da97','OPB:00378')]}}
...
local_process={'D_glucose_transmembrane_transporter_activity': {'type': 'local','term': 'GO:0055056', 'source': [('local', 'glucose_out',1)], 'sink': [('local','glucose_in',1)],
                                                      'mediator':('local','facilitated_glucose_transporter'), 'hasProperty': [('b4da98','OPB:00592')]}}
...
annot_editor.serialize(current_dir + '/GLUT2_BG_annotated.ttl', format='ttl')
